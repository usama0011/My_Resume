    ...
    <div className={styles.container}>
      <div className={styles.contact_Container}>
        <div className={styles.contact_left}>
          ...
          <p>
            We open for any suggestion or just <br /> to have a chat
          </p>
          ...
          <div className={styles.address_box}>
            ...
            <p>
              Email:<a href="https://gmail.google.com "> za5232208@gmail.com</a>
            </p>
          </div>
          <div className={styles.address_box}>
          ...
          <div className={styles.address_box}>
            ...
            <p>
              LinkedIn: <a href="www.linkedin.com/in/usama-ahmad22"></a>
              www.linkedin.com/in/usama-ahmad22
            </p>
          </div>
        </div>
